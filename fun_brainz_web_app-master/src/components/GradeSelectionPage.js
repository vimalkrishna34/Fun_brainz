    ...
    <div className="grade-selection-page">
      ...
      <div className="grade-cards">
        ...
        <motion.div
          ...
          onClick={() => navigate('/math-game/grade-1')}
        >
          <img src="/images/grade-1.jpg" alt="Grade 1" className="card-image" />
          <h3>Grade 1</h3>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
          transition={{ duration: 0.3 }}
          onClick={() => navigate('/math-game/grade-2')}
        >
          <img src="/images/grade-2.jpg" alt="Grade 2" className="card-image" />
          <h3>Grade 2</h3>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
          transition={{ duration: 0.3 }}
          onClick={() => navigate('/math-game/grade-3')}
        >
          <img src="/images/grade-3.jpg" alt="Grade 3" className="card-image" />
          <h3>Grade 3</h3>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
          transition={{ duration: 0.3 }}
          onClick={() => navigate('/math-game/grade-4')}
        >
          <img src="/images/grade-4.jpg" alt="Grade 4" className="card-image" />
          <h3>Grade 4</h3>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
          transition={{ duration: 0.3 }}
          onClick={() => navigate('/math-game/grade-5')}
        >
          <img src="/images/grade-5.jpg" alt="Grade 5" className="card-image" />
          <h3>Grade 5</h3>
